...
- Usage: Reference from command with `@/home/milgraph/Projects/algo_framework/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/milgraph/Projects/algo_framework/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/milgraph/Projects/algo_framework/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
